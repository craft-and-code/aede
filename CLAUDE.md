...
**Current state: milestone M0.5.** Folder scanning, native tag reading, graph model, statistics, diagnostics, command-line navigation — and what the user writes about it: favourites, ratings, notes, free tags, listening history.
